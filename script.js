    ...
    try {
        ...
        if (data.analysis) {
            resultDiv.innerHTML = `
                ...
                <p><strong>Experience:</strong> ${data.analysis.experience.length > 0 ? data.analysis.experience.join(", ") : "None"}</p>
                <p><strong>Skills:</strong> ${data.analysis.skills.length > 0 ? data.analysis.skills.join(", ") : "None"}</p>
            `;
        } else {
